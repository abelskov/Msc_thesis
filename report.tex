...
\input{Sections/Reversible_Computing/Motivation.tex}
\input{Sections/Reversible_Computing/Theory.tex}
%\input{Sections/Reversible_Computing/reversible_turing_machine.tex}

% Baggrund om side channel vulnerabilities og ARM
...
\input{Sections/Hermes_To_ARM/Hermes_To_RSSA.tex}
\input{Sections/Hermes_To_ARM/RSSA_To_ARM.tex}

%\input{Sections/Hermes/grammar.tex}
%\input{Sections/Hermes/Type_system.tex}
%\input{Sections/Hermes/Implementation.tex}
%\input{Sections/Hermes/Unittest_typesystemsystem.tex}
%\input{Sections/Hermes/reversibility_sidechannel.tex}
%\input{Sections/Hermes/Compilation_fixes.tex}
...
%\input{Sections/Lightweight_Cryptography/Reversible_TEA_implementation.tex}
%\input{Sections/Lightweight_Cryptography/Reversible_RC5_implementation.tex}
%\input{Sections/Lightweight_Cryptography/Testing_implementations.tex}
