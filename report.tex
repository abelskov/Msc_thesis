...
\input{Sections/2-Background/Theory.tex}

\label{chapt - Side-channel}
\input{Sections/2-Background/Side-channel.tex}
\input{Sections/2-Background/Examples.tex}
...
\input{Sections/4-Implementation/RSSAcompiler.tex}
%\input{Sections/Grammars/ARM_grammar.tex}
\input{Sections/4-Implementation/RSSA_To_ARM.tex}
\input{Sections/4-Implementation/ARMcompiler.tex}
...
\input{Sections/6-Benchmarks/Benchmarks.tex}

\chapter{Discussion}
\label{chapt - Discussion}
%\input{Sections/7-Discussion/part1.tex}
...
\input{Sections/8-Conclusions/Contributions.tex}
\input{Sections/8-Conclusions/Future_work.tex}
